        ...
        <div className='PAGE'>
            <div className='page'>
                <div className='page_row'>
                    <Link to="/ProductDetail101">
                        <Product
                            id="123456"
                            image="https://m.media-amazon.com/images/I/71NJcWMFAML._AC_UL600_FMwebp_QL65_.jpg"
                            title="ginoya brothers 36 Pieces Pink & Grey Fancy Head-Wear Accessories For Baby Girls/Toddlers [1 Pack]"
                            price={499}
                            rating={5}  ></Product>
                    </Link>
                    <Link to="/ProductDetail102">
                        <Product
                            id="123456"
                ...
                <div className='page_row'>
                    ...
                    <Link to="/ProductDetail">
                        <Product
                            ...
                            title="okos Men's Stainless Steel Jewellery Set Combo Pack of 2 Cuboid Vertical Bar Pendant With 1 Rhodium Plated Rice Shape Link Neck Chain And 1 Black Finish Full Kada Bracelet For Boys and Men CO1000438"
                            price={299}
                            rating={5}  ></Product>
                    </Link>
                    <Link to="/ProductDetail">
